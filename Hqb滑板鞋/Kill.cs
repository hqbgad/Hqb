...
namespace Kalista
{
    static class Killable
    {
        ...
        public static Orbwalking.Orbwalker Orbwalker { get { return Orbwalker; } }
        public static Spell E { get; private set; }
        public static bool HasUBuff(this Obj_AI_Base target)
        {
        ...
        public static void OnPostTick(EventArgs args)
        {
